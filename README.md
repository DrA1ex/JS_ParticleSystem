...
- *min_distance* - Minimal distance (pixels) to process interactions (default: __20__)
- *distance_mul* - Distance multiplier, can be used to emulate interaction between far objects (default: __1__)
