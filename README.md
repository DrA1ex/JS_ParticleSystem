...
- *particle_init* - Particle initialization, values: __circle__, __disk__, __bang__, __uniform__, __rotation__, __collision__, __swirl__ (default: __circle__)
...
- *collision_size* - Sets particle collider size (default: __1__)
- *render* - Configure renderer type: __canvas__, __webgl2__ (default: __canvas__ for mobile, __webgl__ for desktop)
- *particle_scale* - Sets particle size scale (2 - means 2x bigger) (default: __1__)
...
- *slow_motion* - Slow down simulation (0.1 - means 10x slower) (default: __1__)
