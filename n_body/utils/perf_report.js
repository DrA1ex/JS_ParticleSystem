...
function snapshotSettings(app) {
    ...
    return {
        ...
        render: {
            ...
            fixedColor: settings.render.fixedColor,
...
function snapshotApp(app, collectorRafInterval, collectorTimestamp) {
    ...
    return {
        ...
        render: {
            ...
            staticColorStatus: rendererStats.staticColorStatus || null,
...
function summarizeSlowFrames(samples, targetFrameTime) {
    ...
    return samples
        ...
        .map(sample => ({
            ...
            staticColorStatus: sample.render?.staticColorStatus || null,
...
export async function collectPerformanceReport(app, options = {}) {
    ...
    const report = {
        ...
        comparisonKey: {
            ...
            fixedColor: app.settings.render.fixedColor,
