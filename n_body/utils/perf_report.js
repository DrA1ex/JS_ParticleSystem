...
function cloneWorkerMTState(state) {
    ...
    return {
        ...
        treeEarlySplitResults: finite(state.treeEarlySplitResults),
        treeEarlySplitJobs: finite(state.treeEarlySplitJobs),
        treeHybridEarlyDispatches: finite(state.treeHybridEarlyDispatches),
        treeHybridMixedDispatches: finite(state.treeHybridMixedDispatches),
        treeHybridBatchedJobs: finite(state.treeHybridBatchedJobs),
        treeHybridMaxBacklog: finite(state.treeHybridMaxBacklog),
        treeHybridLocalJobs: finite(state.treeHybridLocalJobs),
        treeHybridRejectedSplits: finite(state.treeHybridRejectedSplits),
        recursiveSplitCount: finite(state.recursiveSplitCount),
        recursiveSplitTime: finite(state.recursiveSplitTime),
...
const BLOCK_METRICS = {
    ...
    "physics.mt.treeEarlySplitResults": "physics.workerMT.treeEarlySplitResults",
    "physics.mt.treeEarlySplitJobs": "physics.workerMT.treeEarlySplitJobs",
    "physics.mt.treeHybridEarlyDispatches": "physics.workerMT.treeHybridEarlyDispatches",
    "physics.mt.treeHybridMixedDispatches": "physics.workerMT.treeHybridMixedDispatches",
    "physics.mt.treeHybridBatchedJobs": "physics.workerMT.treeHybridBatchedJobs",
    "physics.mt.treeHybridMaxBacklog": "physics.workerMT.treeHybridMaxBacklog",
    "physics.mt.treeHybridLocalJobs": "physics.workerMT.treeHybridLocalJobs",
    "physics.mt.treeHybridRejectedSplits": "physics.workerMT.treeHybridRejectedSplits",
    "physics.mt.recursiveSplitCount": "physics.workerMT.recursiveSplitCount",
    "physics.mt.recursiveSplitTime": "physics.workerMT.recursiveSplitTime",
...
function summarizeWorkerMTBlocks(blocks) {
    ...
    return {
        ...
        treeEarlySplitResults: summarizeAcrossBlocks(blocks, "physics.mt.treeEarlySplitResults"),
        treeEarlySplitJobs: summarizeAcrossBlocks(blocks, "physics.mt.treeEarlySplitJobs"),
        treeHybridEarlyDispatches: summarizeAcrossBlocks(blocks, "physics.mt.treeHybridEarlyDispatches"),
        treeHybridMixedDispatches: summarizeAcrossBlocks(blocks, "physics.mt.treeHybridMixedDispatches"),
        treeHybridBatchedJobs: summarizeAcrossBlocks(blocks, "physics.mt.treeHybridBatchedJobs"),
        treeHybridMaxBacklog: summarizeAcrossBlocks(blocks, "physics.mt.treeHybridMaxBacklog"),
        treeHybridLocalJobs: summarizeAcrossBlocks(blocks, "physics.mt.treeHybridLocalJobs"),
        treeHybridRejectedSplits: summarizeAcrossBlocks(blocks, "physics.mt.treeHybridRejectedSplits"),
        recursiveSplitCount: summarizeAcrossBlocks(blocks, "physics.mt.recursiveSplitCount"),
        recursiveSplitTime: summarizeAcrossBlocks(blocks, "physics.mt.recursiveSplitTime"),
...
function buildCompactSummaryRows(reports) {
    return reports.map((report, index) => ({
        ...
        mtEarly: fixed(metricAvg(report, "summary.workerMT.treeHybridEarlyDispatches"), 0),
        mtMixed: fixed(metricAvg(report, "summary.workerMT.treeHybridMixedDispatches"), 0),
        mtRejected: fixed(metricAvg(report, "summary.workerMT.treeHybridRejectedSplits"), 0),
